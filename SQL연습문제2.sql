...
insert into student values ('20120323', '강감찬', '1991-02-09', '영문학과', '2012-02-01');
...
final_score, total_score, grade from student s
...
group by s.stdno, s.name order by stdno asc;
