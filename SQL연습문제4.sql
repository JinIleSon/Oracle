...
create table book (
    ...
    publisher nvarchar2(40) not null,
    available char(1),
...
delete book where book_id = 10007;
delete book where book_id = 10010;
...
insert into loan(loan_id, member_id, book_id, loan_date, return_date) values ('3', '1003', '10008', '2024-04-01 11:01:12', '2024-04-15 11:01:12');
insert into loan values ('4', '1002', '10001', '2024-04-10 14:32:01', '2024-04-24 14:32:01', '2024-04-22 13:56:32');
insert into loan(loan_id, member_id, book_id, loan_date, return_date) values ('5', '1005', '10004', '2024-04-15 16:24:21', '2024-04-29 16:24:21');
...
insert into loan(loan_id, member_id, book_id, loan_date, return_date) values ('8', '1003', '10009', '2024-06-01 11:15:43', '2024-06-15 11:15:43');
insert into loan(loan_id, member_id, book_id, loan_date, return_date) values ('9', '1004', '10004', '2024-06-02 12:30:52', '2024-06-16 12:30:52');
insert into loan(loan_id, member_id, book_id, loan_date, return_date) values ('10', '1002', '10008', '2024-06-05 10:06:17', '2024-06-19 10:06:17');

delete loan where loan_id = 3;
-- 실습 4-4
