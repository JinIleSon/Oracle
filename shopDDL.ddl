...
CREATE TABLE "Order" (
    ...
    orderproduct   INTEGER DEFAULT 1 NOT NULL,
    orderCount     INTEGER,
...
ALTER TABLE "Order"
    ADD CONSTRAINT order_product_fk FOREIGN KEY ( product_prodno )
...
insert into product values (2, '초코팜', 2500, 2500, '오리온');
