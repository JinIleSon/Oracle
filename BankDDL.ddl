...
CREATE TABLE bank_account (
    ...
    a_balance   INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE bank_customer (
    ...
    c_dist  INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE bank_transaction (
    ...
    t_dist     INTEGER NOT NULL,
    t_amount   INTEGER DEFAULT 0 NOT NULL,
...
CREATE SEQUENCE b
ank_transaction_t_no_seq START WITH 1 NOCACHE ORDER;
...
select c_no,
       ...
       join bank_account a
       on b.c_no = a.a_c_no
       where a.a_balance in (select max(a_balance) from bank_account);
