...
ALTER TABLE bo_book ADD CONSTRAINT table_6_pk PRIMARY KEY ( bookid );

CREATE TABLE bo_customer (
    custid  VARCHAR2(100 BYTE) NOT NULL,
    name    VARCHAR2(100 BYTE),
    address VARCHAR2(100 BYTE)
);

ALTER TABLE bo_customer ADD CONSTRAINT table_4_pk PRIMARY KEY ( custid );
