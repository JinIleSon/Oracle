...
insert into customer values('c103', '장보고', '010-1234-1003', '김해시 봉황동', '2022-01-03');
insert into customer values('c104', '강감찬', '010-1234-1004', '김해시 봉황동', '2022-01-04');
...
insert into orders values(8, 'c104', 2, 4, '2022-07-04 14:12:12');
...
group by ord_pno, ord_cid order by ord_pno asc;
...
where ord_date between '2022-07-03' and '2022-07-04';